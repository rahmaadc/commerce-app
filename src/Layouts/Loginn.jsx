  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center">
      <div className="bg-white rounded-xl px-4 py-16 flex flex-col justify-center items-center">
        <h1 className="uppercase font-bold text-[24px] text-black py-4">se connecter</h1>
        <form method="post" className="w-[70%] flex flex-col gap-10 justify-center items-center">
          <input
            type="email"
            placeholder="Email"
        ...
        {insc && <div className="flex flex-col w-[60%] justify-center items-center gap-2">
